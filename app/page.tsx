...
export default function Home() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-5xl xl:px-0 flex min-h-screen items-center justify-center">
      <main className="">
        <p className="text-[40px] font-bold">hey there! i&apos;m kenny :&#41;</p>
        <p className="mt-4 text-2xl">a software engineer who loves —</p>
        <p className="text-xl mt-3"><span className="text-gray-400 mx-5">&gt;</span>writing about <Link href="/blog" className="text-[#3a6e48] hover:underline font-semibold">things I learned, self-improvement, and tech</Link></p>
        ...
        <p className="text-xl mt-2"><span className="text-gray-400 mx-5">&gt;</span>outdoor activities, sports, <a href="https://letterboxd.com/kennywan/" className="text-[#3a6e48] hover:underline font-semibold">movies</a>, and <a href="https://open.spotify.com/user/imkennywan/" className="text-[#3a6e48] hover:underline font-semibold">music</a></p>
        <p className="mt-8 text-xl mb-6">currently, i&apos;m building cool stuff @ <a href="https://robinhood.com/" className="text-[#3a6e48] hover:underline font-semibold">robinhood</a></p>
